...
const Features = () => {
    return(
        <div className='relative -top-[150px] md:-top-[230px] min-h-[140vh] md:min-h-[95vh] clip-path-3 md:clip-path-4 w-full bg-cover bg-center bg-no-repeat' style={{backgroundImage: `url(${bg2})`}}>
