...
const Features = () => {
    return(
        <div id='features' className='relative min-h-[140vh] md:min-h-[115vh] clip-path-3 md:clip-path-4 w-full bg-cover bg-center bg-no-repeat' style={{backgroundImage: `url(${bg2})`}}>
