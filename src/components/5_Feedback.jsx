...
const Feedback = () => {
    ...
    return (
        <div id='feedback' className='relative w-full gap-y-8 md:gap-y-12 flex flex-col items-center justify-center'>
            <video id='feedback' autoPlay muted loop className='absolute w-full opacity-10'>
