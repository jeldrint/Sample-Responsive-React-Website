...
const Description = () => {
    return(
        <div className='h-[95vh] w-full flex flex-col items-center md:pt-20 clip-path-1'>
            ...
            <br /><br />
            <div className="h-full w-[320px] md:min-w-[700px] lg:min-w-[950px] flex flex-col md:flex-row gap-x-[100px]">
